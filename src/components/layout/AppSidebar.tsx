  ...
  return (
    <>
      ...
      <div className="sidebar-footer-languages flex align-items-center justify-content-center gap-3 pb-4">
        <button
          type="button"
          className="p-link inline-flex justify-content-center align-items-center w-3rem h-3rem border-circle hover:bg-primary transition-all transition-duration-200"
      ...
      <div
        className="sidebar-footer-version text-center text-sm font-medium pb-4"
        style={{ color: "var(--menuitem-text-color, var(--text-color, #fff))" }}
      >
        v{pkg.version}
      </div>
    </>
