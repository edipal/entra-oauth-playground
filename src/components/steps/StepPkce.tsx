        ...
        <div className="grid formgrid p-fluid gap-3">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'minmax(12rem, 14rem) 1fr', alignItems: 'center', columnGap: '0.75rem' }}>
              ...
              <div>
                <div className="flex gap-2 align-items-center">
                  <InputText id="codeVerifier" className={`flex-1${showCodeVerifierInvalid ? ' p-invalid' : ''}`} value={codeVerifier} onChange={(e) => setCodeVerifier(e.target.value)} placeholder={t('placeholders.codeVerifier')} style={{ width: '100%' }} />
                  <Button
                    type="button"
                    icon="pi pi-refresh"
          ...
          <div className="col-12 md:col-12">
            <div style={{ display: 'grid', gridTemplateColumns: 'minmax(12rem, 14rem) 1fr', alignItems: 'center', columnGap: '0.75rem' }}>
              ...
              <div>
                <InputText id="codeChallenge" value={codeChallenge} onChange={() => {}} placeholder={t('placeholders.codeChallenge')} readOnly className={showCodeChallengeInvalid ? 'p-invalid' : ''} style={{ width: '100%' }} />
