    ...
    <>
      ...
      {currentStep === StepIndex.Settings && (
        <StepSettings
          ...
          setStreamlined={(v: boolean) => setAuthCodeConfidentialClientConfig({ streamlined: v })}
      ...
      {currentStep === StepIndex.CallApi && (
        <StepCallApi
          ...
          setApiEndpointUrl={(v: string) => setAuthCodeConfidentialClientConfig({ apiEndpointUrl: v })}
          accessToken={accessToken}
