...
export default function AuthorizationCodeConfidentialClientPage() {
  ...
  const authEndpoint =
    authCodeConfidentialClientRuntime.authEndpoint ||
    "https://login.microsoftonline.com/{tenant}/oauth2/v2.0/authorize";
  const tokenEndpoint =
    authCodeConfidentialClientRuntime.tokenEndpoint ||
  ...
  const validators: Record<StepIndex, () => boolean> = {
    ...
    [StepIndex.Settings]: () =>
      clientIdValid && redirectUriValid && tenantIdValid,
    [StepIndex.Pkce]: () =>
