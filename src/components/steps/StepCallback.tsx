        ...
        <div className="grid formgrid p-fluid gap-3">
          ...
          {!hasCallbackError && (
            <>
              {authCode && (
                <div className="col-12">
                  <div className="flex gap-2 align-items-center" aria-live="polite" style={{ lineHeight: 1 }}>
                    <h5 className="m-0" style={{ lineHeight: 1 }}>{t('sections.callback.okTitle') ?? 'Callback OK'}</h5>
              ...
              <div className="col-12">
                <div style={{ display: 'grid', gridTemplateColumns: 'minmax(12rem, 14rem) 1fr', alignItems: 'center', columnGap: '0.75rem' }}>
                  ...
                  <div>
                    <InputText id="authCode" value={authCode} readOnly style={{ width: '100%' }} />
                  </div>
                </div>
              </div>
              <div className="col-12">
                <div style={{ display: 'grid', gridTemplateColumns: 'minmax(12rem, 14rem) 1fr', alignItems: 'center', columnGap: '0.75rem' }}>
                  ...
                  <div>
                    <InputText id="extractedState" value={extractedState} readOnly style={{ width: '100%' }} />
                    {hasExpected && (
          ...
          {hasCallbackError && (
            <div className="col-12">
              <div className="flex gap-2 align-items-center" aria-live="polite">
                <h5 className="m-0" style={{ lineHeight: 1 }}>{t('sections.callback.errorTitle') ?? 'Callback error'}</h5>
                ...
                <div className="grid formgrid p-fluid gap-3">
                  <div className="col-12">
                    <div style={{ display: 'grid', gridTemplateColumns: 'minmax(12rem, 14rem) 1fr', alignItems: 'center', columnGap: '0.75rem' }}>
                      ...
                      <div>
                        <InputText id="callbackError" value={cbError} readOnly style={{ width: '100%' }} />
                      </div>
                    </div>
                  </div>
                  <div className="col-12">
                    <div style={{ display: 'grid', gridTemplateColumns: 'minmax(12rem, 14rem) 1fr', alignItems: 'center', columnGap: '0.75rem' }}>
                      ...
                      <div>
                        <InputText id="callbackErrorUri" value={cbErrorUri} readOnly style={{ width: '100%' }} />
                      </div>
                    </div>
                  </div>
                  <div className="col-12">
                    <div style={{ display: 'grid', gridTemplateColumns: 'minmax(12rem, 14rem) 1fr', alignItems: 'start', columnGap: '0.75rem' }}>
                      ...
                      <div>
                        <InputTextarea id="callbackErrorDescription" rows={3} autoResize value={decodeURIComponent(cbErrorDescription)} style={{ width: '100%' }} />
                      </div>
                    </div>
                  </div>
                </div>
