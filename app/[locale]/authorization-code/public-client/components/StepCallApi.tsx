    ...
    <section>
      ...
      <div className="grid formgrid p-fluid">
        ...
        <div className="col-12">
          ...
          <InputTextarea id="apiHeaders" rows={3} autoResize value={accessToken ? `Authorization: Bearer ${accessToken}` : ''} placeholder={tRaw('placeholders.apiHeaders')} />
        </div>
        <div className="col-12">
          <LabelWithHelp id="apiResponse" text={t('labels.apiResponse')} help={t('help.apiResponse')} />
          <InputTextarea id="apiResponse" rows={8} autoResize value={apiResponseText} placeholder={tRaw('placeholders.apiResponse')} />
        </div>
      </div>
    </section>
  );
